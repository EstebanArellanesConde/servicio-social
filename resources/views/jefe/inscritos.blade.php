...
@section('main')
    <h1 class="mt-2 ml-2 mb-6">Alumnos Inscritos</h1>
    ...
    <div class="mt-12 overflow-auto rounded-lg shadow">
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-200">
                @foreach($alumnosInscritos as $alumnos)
                <tr class="{{ $loop->iteration % 2 === 0 ? 'even:bg-gray-50' : 'odd:bg-white' }}">
                    ...
                    <td class="text-center p-3 text-gray-700">
                        <div className="flex flex-col w-max gap-8">
                            <ButtonGroup>
                                <button type="button" class="text-white bg-green-700 hover:bg-green-800  font-medium rounded-lg text-sm px-2 py-2">Finalizar</button>
                                <button type="button" class="text-white bg-sky-500 hover:bg-sky-600  font-medium rounded-lg text-sm px-3.5 py-2">Datos</button>
                                <button type="button" class="text-white bg-red-700 hover:bg-red-800  font-medium rounded-lg text-sm px-5 py-2">Baja</button>
                            </ButtonGroup>
                        </div>
                    </td>
                </tr>
