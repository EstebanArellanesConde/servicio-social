<form wire:submit.prevent="store">
    ...
    <div class="mt-4 md:flex md:space-x-2">
        ...
        <div class="{{ $interno == "0" || $interno == "1" || $interno == "2" ? "md:w-1/2" : "md:w-full" }} w-full mt-4 md:mt-0">
            ...
            >
                ...
                <option id="interno_fi" value="0">Facultad de Ingeniería (UNAM)</option>
                <option id="interno_unam" value="1">Otras escuelas de la UNAM</option>
        ...
        <div id="carrera_interna" class="{{ $interno === "0" ? "block" : "hidden" }} w-full md:w-1/2 mt-4 md:mt-0">
        ...
        <div class="{{ $interno === "1" ? "block" : "hidden" }} w-full md:w-1/2 mt-4 md:mt-0">
        ...
        <div class="{{ $interno === "2" ? "block" : "hidden" }} w-full md:w-1/2 mt-4 md:mt-0">
            ...
            <x-text-input id="escuela_text" placeholder="Indique su escuela" class="block mt-2 w-full" type="text" wire:model.lazy="escuela_text" required/>
    ...
    <!-- Fecha de ingreso -->
    <div class="{{ $interno == "0" ? "block" : "hidden" }} mt-4">
