    ...
    >
        <div class="grid lg:grid-cols-2 grid-cols-1 gap-2">
            <div>
                ...
                <input
                    type="date"
                    wire:model.lazy="periodo_inicio"
                    id="periodo_inicio"
        ...
        <div>
            <x-input-error :messages="$errors->get('periodo_inicio')" class="mt-2" />
            <x-input-error :messages="$errors->get('periodo_fin')" class="mt-2" />
        </div>
